...
tx = hack.functions.validate(factoryAddr, 0x694895f0ac82f676910fdfd20a69c1dccfd54fec2440cb6cc9bca05dc51e62c7).buildTransaction({
    'nonce': w3.eth.getTransactionCount(account),
    'gas': hack.functions.validate(factoryAddr, 0x694895f0ac82f676910fdfd20a69c1dccfd54fec2440cb6cc9bca05dc51e62c7).estimateGas(),
